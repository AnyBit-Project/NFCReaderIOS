...
`public func getCardInfo(config: NFCConfig? = nil, callback: @escaping (String) -> Void)`

Success return：aid#serial#publicKey<br>
Uninitialized return：aid#serial#6D05<br>

## 2.Initialize Device
`public func initCard(version: String, password: String, initStr: String, config: NFCConfig? = nil, callback: @escaping (String) -> Void)`
...
## 3.Verify Password
`public func verifyPassword(password: String, config: NFCConfig? = nil, callback: @escaping (String) -> Void)`

password: Device password (6-digit number)<br>
Success return：9A00<br>

## 4.Write Password
`public func writePassword(password: String, config: NFCConfig? = nil, callback: @escaping (String) -> Void)`

password: Device password (6-digit number)<br>
Success return：9A00<br>

## 5.Change Password
`public func changePassword(oldPassword: String, newPassword: String, config: NFCConfig? = nil, callback: @escaping (String) -> Void)`
...
## 7.Strat Send BTC
`public func transferBTC(password: String, config: NFCConfig? = nil, callback: @escaping (String) -> Void)`

password: Device password (6-digit number)<br>
Success return：9A00<br>

## 8.Sign BTC (Sign a single input of BTC)
`public func signBTC(command: String, password: String, callback: @escaping (String) -> Void)`
...
`transferTRX(version: String, password: String, hashStr: String, config: NFCConfig? = nil, callback: @escaping (String) -> Void)`
...
`public func transferEVM(version: String, password: String, hashStr: String, config: NFCConfig? = nil, callback: @escaping (String) -> Void)`
...
`public func readSeed(password: String, isOnlyRead: Bool, seed: String, config: NFCConfig? = nil, callback: @escaping (String) -> Void)`
...
`public func writeSeed(password: String, seed: String, config: NFCConfig? = nil, callback: @escaping (String) -> Void)`
